...
export declare class Menu {
    ...
    variable<T extends (string | boolean)>(name: keyof MenuSettings, action?: (value: T) => void): {
        name: "subtitles" | "semantics" | "scale" | "speech" | "magnification" | "highlight" | "explorer" | "braille" | "viewBraille" | "shift" | "backgroundColor" | "alt" | "texHints" | "zoom" | "zscale" | "renderer" | "cmd" | "ctrl" | "autocollapse" | "collapsible" | "inTabOrder" | "assistiveMml" | "foregroundColor" | "infoPrefix" | "infoRole" | "infoType" | "magnify" | "speechRules" | "treeColoring";
